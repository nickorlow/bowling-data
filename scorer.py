...
index_file.write(f"<script>if(!new URL(window.location.href).searchParams.get(\"af\")||new URL(window.location.href).searchParams.get(\"af\")===\"true\")window.location.href=\"./april_fools.html\";</script>")
index_file.write("</body>")
index_file.close()
